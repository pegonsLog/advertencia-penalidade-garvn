...
import { AgenteService } from '../../agentes/agente.service';
...
export class IrregularidadeAlterarComponent {
      ...
      this.subscription = this.#irregularidadeService
        ...
        .subscribe((result: IIrregularidade) => {
          this.irregularidadeForm = this.#fb.group({
            ...
            prazoCumprimentoConferencia: [
              result.prazoCumprimentoConferencia, Validators.pattern(/^\d{2}\/\d{2}\/\d{4}$/)
            ],
            matAgenteConferente: [
  ...
  irregularidadeIIrregularidadeFormEdit(
    ...
    this.irregularidadeForm = this.#fb.group({
      ...
      dataEmissao: [
        irregularidadeIIrregularidade.dataEmissao, Validators.pattern(/^\d{2}\/\d{2}\/\d{4}$/)
      ],
      prazoCumprimentoConferencia: [
        irregularidadeIIrregularidade.prazoCumprimentoConferencia, Validators.pattern(/^\d{2}\/\d{2}\/\d{4}$/)
      ],
      matAgenteConferente: [
